                            ...
                            <div class="login-signin">
                                ...
                                <form class="form mt-4" id="kt_login_signin_form">
                                    ...
                                    <div class="form-group d-flex flex-wrap justify-content-between align-items-center">
                                        ...
                                        <a href="{{url('/forgot-password')}}" id="kt_login_forgot" class="text-hover-primary forgot-password">Forget Password ?</a>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <a href="{{url('/dashboard')}}"  class="btn btn-block btn-primary font-weight-bold px-9 py-4">Sign In</a>
                                        </div>      
                                    </div>
                                </form>
                            </div>
