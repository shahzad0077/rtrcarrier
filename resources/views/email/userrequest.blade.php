...
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
        ...
        <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:left;color:white;">
            Hello {{ $name }}!<br></br>
            Thank you for signing up for {{ env('APP_NAME') }}. We're really happy to have you! Your Request Submited Successfully. Once We Approve your Account then you will be Enjoy {{ env('APP_NAME') }} App.<br> Click the link below to login to your account:
        </div>
