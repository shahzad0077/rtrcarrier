        ...
        <div class="card-body pt-4">
            ...
            <div class="d-flex align-items-center">
                <div class="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center">
                    @if($data->logo)
                    <div class="symbol-label" style="background-image:url('{{ url('') }}/public/images/{{ $data->logo  }}')"></div>
                    @else
                    <div class="symbol-label" style="background-image:url('{{ url('') }}/public/carrier/assets/profile.jpg')"></div>
                    @endif
                    <!-- <i class="symbol-badge bg-success"></i> -->
                </div>
                <div>
                    <a href="javascript:void(0)" class="font-weight-bolder font-size-h5 text-dark-75 text-hover-primary">
                       {{ $data->company_name }}
                    </a>
                    <div class="text-muted">
                       Carrier Admin Name :  {{ $data->user_name }}
                    </div>
                </div>
            </div>
            <!--end::User-->
            ...
            <div class="py-9">
                ...
                <div class="d-flex align-items-center justify-content-between mb-2">
                    ...
                    <span class="text-muted">{{ $data->contact_number }}</span>
                </div>
            ...
            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                <div class="navi-item mb-2">
                    <a href="{{ url('admin/carriers/detail') }}/{{ $data->id }}/detail" class="navi-link py-4 @if($page == 'detail') active @endif">
                ...
                <div class="navi-item mb-2">
                    <a href="{{ url('admin/carriers/detail') }}/{{ $data->id }}/personal" class="navi-link py-4 @if($page == 'personal') active @endif">
                        <span class="navi-icon mr-2">
                            <span class="svg-icon">
                ...
                <div class="navi-item mb-2">
                    <a href="{{ url('admin/carriers/detail') }}/{{ $data->id }}/changepassword" class="navi-link py-4 @if($page == 'changepassword') active @endif">
                        <span class="navi-icon mr-2">
                            <span class="svg-icon">
                ...
                <div class="navi-item mb-2">
                    <a href="{{ url('admin/carriers/detail') }}/{{ $data->id }}/allmaps" class="navi-link py-4 @if($page == 'allmaps') active @endif">
                        <span class="navi-icon mr-2">
                            <span class="svg-icon">
                ...
                <div class="navi-item mb-2">
                    <a href="{{ url('admin/carriers/detail') }}/{{ $data->id }}/alljobs" class="navi-link py-4 @if($page == 'alljobs') active @endif" data-toggle="tooltip" title="" data-placement="right" data-original-title="Coming soon...">
                        <span class="navi-icon mr-2">
                            <span class="svg-icon">
                    ...
                    <a href="{{ url('admin/carriers/detail') }}/{{ $data->id }}/allteam" class="navi-link py-4 @if($page == 'allteam') active @endif">
                        <span class="navi-icon mr-2">
                            <span class="svg-icon">
                                ...
                                <!--end::Svg Icon--></span> </span>
                        <span class="navi-text font-size-lg">ALL Team Members</span>
                    </a>
                </div>
            </div>
            <!--end::Nav-->
