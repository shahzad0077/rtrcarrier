                    ...
                    <div class="card card-custom">
                        ...
                        <div class="card-header py-3">
                            <div class="card-title align-items-start flex-column">
                                <h3 class="card-label font-weight-bolder text-dark">Edit Hiring Templates of Job : {{ $job->job_tittle }} <span class="text-danger">(This Section is Under Construction)</span></h3>
                                <span class="text-muted font-weight-bold font-size-sm mt-1">
                                    <a class="badge badge-success" href="{{ url('admin/carriers/editjob') }}/{{ $data->id }}/{{ $job->id }}/basic">Basic Details</a>
                                    <a style="background-color: #159892;"  class="badge badge-success" href="{{ url('admin/carriers/editjob') }}/{{ $data->id }}/{{ $job->id }}/hiring">Hiring Templates</a>
