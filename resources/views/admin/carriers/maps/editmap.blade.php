...
<li class="breadcrumb-item">
    <a href="{{ url('admin/carriers/detail') }}/{{$data->id}}/allmaps" class="text-muted">All Maps</a>
</li>
<li class="breadcrumb-item">
    <a href="javascript:void(0)" class="text-muted">Edit Map: {{ $map->tittle }}</a>
</li>
@endsection
@section('content')
@php
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input value="{{ $map->tittle }}" required onkeyup="maptittle()" id="map_tittle" type="text" class="form-control form-control-lg form-control-solid" name="map_tittle" placeholder="RTR-WFX-hiringmap-5.16.22">
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    ...
                                                    <div class="upload-logo"  style="background-image: url('{{ url("public/images")  }}/{{ $map->logo  }}');">
                                                        ...
                                                        <input id="selectimage" style="display:none;" name="logo"  accept=".png, .jpg, .jpeg" type='file' onchange="readURL(this);" />
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
