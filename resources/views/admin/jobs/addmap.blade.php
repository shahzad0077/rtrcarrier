...
<li class="breadcrumb-item">
    <a href="javascript:void(0)" class="text-muted">Select a carrier to begin adding Map on their behalf.
</a>
</li>
@endsection
@section('content')
                                ...
                                <div class="card card-custom card-stretch">
                                    <div class="card-header">
                                        <div class="card-title">
                                            <h3 class="card-label">
                                                Add New Map
                                                <div class="text-muted pt-2 font-size-sm">Select a carrier to begin adding Map on their behalf.</div>
                                            </h3>
                                        </div>
                                    </div>
                                    <form method="POST" action="{{ url('admin/jobs/assigncarrierformap') }}">
                                        @csrf
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12">
