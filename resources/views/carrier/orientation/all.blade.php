...
@section('title','Orientation Templates')
@section('pagename')
<li class="breadcrumb-item">
    <a href="javascript:void(0)" class="text-muted">Orientation Templates</a>
</li>
@endsection
@section('content')
            ...
            <div class="card card-custom mt-5">
                <div class="card-header border-0 py-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label font-weight-bolder text-dark">All Orientation Templates</span>
                        <span class="text-muted mt-3 font-weight-bold font-size-sm">Manage All Orientation Templates</span>
                    </h3>
                    <div class="card-toolbar">
                        <a href="{{url('add-new-orientation-template')}}" class="btn btn-info font-weight-bolder font-size-sm">Add New Orientation Template</a>
                    </div>
                </div>
                <div class="card-body">
                    <table id="example" class="table table-separate table-head-custom table-checkable" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td nowrap="">
                                    <a href="{{ url('editorientationtemplate') }}/{{ $r->id }}" class="btn btn-sm btn-clean btn-icon" title="Edit details"> <i class="la la-edit"></i> </a>
