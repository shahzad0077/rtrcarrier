        ...
        <div class=" container ">
            ...
            <div class="d-flex flex-row">
                ...
                <div class="flex-row-fluid ml-lg-8 mt-6">
                    ...
                    <div class="card card-custom">
                        ...
                        <div class="card-header py-3">
                            <div class="card-title align-items-start flex-column">
                                <h3 class="card-label font-weight-bolder text-dark">Edit Hiring Template of Job : {{ $job->job_tittle }}</h3>
                                <span class="text-muted font-weight-bold font-size-sm mt-1">
                                   <a class="badge badge-success" href="{{ url('jobedit') }}/{{ $job->id }}/basic">Basic Details</a>
                                    <a style="background-color: #159892;"  class="badge badge-success" href="{{ url('jobedit') }}/{{ $job->id }}/hiring">Hiring Templates</a>
                    ...
                    <form method="POST" action="{{ url('updatehiringtemplateofjob') }}">
                    @csrf
                    ...
                    <div class="card card-custom mt-3">
                            <div class="card-header">
                                <div class="card-title">
                                    <h3 class="card-label font-weight-bolder text-dark">Update Hiring Template</h3>
                                </div>
                                <div class="card-toolbar text-danger">
                                <!--begin::Button-->
                                   Under Construction
