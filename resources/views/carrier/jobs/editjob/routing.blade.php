        ...
        <div class=" container ">
            ...
            <div class="d-flex flex-row">
                ...
                <div class="flex-row-fluid ml-lg-8 mt-6">
                        ...
                        <div class="card-header py-3">
                            <div class="card-title align-items-start flex-column">
                                ...
                                <span class="text-muted font-weight-bold font-size-sm mt-1">
                                    ...
                                    <a style="background-color: #159892;" class="badge badge-success" href="{{ url('jobedit') }}/{{ $job->id }}/routing">Routing & Transfer</a>
                    ...
                    <form method="POST" action="{{ url('updateroutingofjob') }}">
                        @csrf
                        ...
                        <div class="card card-custom mt-3">
                            <div class="card-header">
                                <div class="card-title">
                                    <h3 class="card-label font-weight-bolder text-dark">Update Routing & Transfer</h3>
                                </div>
