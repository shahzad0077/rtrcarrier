                                            ...
                                            <div class="card">
                                                <div class="card-header" id="headingOne6">
                                                    <div class="card-title" data-toggle="collapse" data-target="#collapseOne6">
                                                        <img src="{{asset('carrier/assets/media/custom/basic-details.svg')}}"> Basic Details
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="headingTwo6">
                                                    <div class="card-title collapsed" data-toggle="collapse" data-target="#collapseTwo6">
                                                        <img src="{{asset('carrier/assets/media/custom/hiring-req.svg')}}"> Hiring Req.
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="headingThree6">
                                                    <div class="card-title collapsed" data-toggle="collapse" data-target="#collapseThree6">
                                                        <img src="{{asset('carrier/assets/media/custom/routing-trans.svg')}}"> Routing & trans.
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="headingFour6">
                                                    <div class="card-title collapsed" data-toggle="collapse" data-target="#collapseFour6">
                                                        <img src="{{asset('carrier/assets/media/custom/preview.svg')}}"> Subscriptions
                                                    </div>
                                                </div>
