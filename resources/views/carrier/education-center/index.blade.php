                        ...
                        <div class="row g-10">
                            ...
                            <div class="col-md-3">
                                <div class="card-xl-stretch me-md-6">
                                    @if($a->youtube)
                                    <iframe style="height:183px !important;" class="embed-responsive-item card-rounded h-275px w-100" src="{{ $a->youtube }}" allowfullscreen="allowfullscreen" data-gtm-yt-inspected-11="true" id="116062210" data-gtm-yt-inspected-31871541_91="true" title="How to Implement an Ajax DataTable"></iframe>
                                    @else
                                    <a href="{{ url('detail') }}/{{ $a->url }}" class="h-275px w-100 d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="height: 100px !important;background-image: url('{{ url('') }}/public/images/{{ $a->image  }}');">
                                    </a>
                                    @endif
                                    <div class="m-0">
                                        ...
                                        <div class="fw-semibold fs-5 text-gray-600 text-dark mt-4">
                                            {!! \Illuminate\Support\Str::limit(strip_tags($a->content), 80, $end='...') !!}
                                        </div>
