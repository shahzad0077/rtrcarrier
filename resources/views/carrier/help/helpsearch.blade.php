        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="row m-10">
                    ...
                    <div class="col-md-6 mx-auto text-center">
                        ...
                        <input value="{{ $_GET['keyword'] }}" type="text" class="form-control " style="min-height:62px; box-shadow: 4px 10px 4px 10px #f1f1f1; border-radius:100px" placeholder="Search for a Question" name="keyword">
                        </form>
                    </div>
                    ...
                    <div class="card card-md-stretch me-xl-3 mb-md-0 mb-6">
                        ...
                        <div class="card-body p-10 p-lg-15">
                            ...
                            <div class="d-flex flex-stack mb-7">
                                <!--begin::Title-->
                                <h1 class="fw-bold text-dark">Search Keyword: {{ $_GET['keyword'] }}</h1>
                                <!--end::Title-->
                            </div>
