            ...
            <div class="d-flex align-items-center mt-5">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        ...
                        <a href="javascript:void(0)" class="btn btn-sm btn-success font-weight-bold py-2 px-3 px-xxl-5 my-1">Active</a>
                        @else
                        <a href="javascript:void(0)" class="btn btn-sm btn-danger font-weight-bold py-2 px-3 px-xxl-5 my-1">In Active</a>
                        @endif
                    </div>
                </div>
            </div>
